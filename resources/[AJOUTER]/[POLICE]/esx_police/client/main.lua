...
Citizen.CreateThread(function()
	...
	if PlayerData.job and PlayerData.job.name == 'police' then 
		exports["rp-radio"]:GivePlayerAccessToFrequencies(1, 2, 3, 4, 5, 6)
	elseif PlayerData.job and PlayerData.job.name == 'ambulance' then
		exports["rp-radio"]:GivePlayerAccessToFrequencies(7, 8)
	elseif PlayerData.job and PlayerData.job.name == 'mecano' then
		exports["rp-radio"]:GivePlayerAccessToFrequencies(9, 10)
	else
...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		elseif data.current.action == 'garage' then
			...
			ESX.TriggerServerCallback('losblancos_vehicleshop:retrieveJobVehicles', function(jobVehicles)
						...
						if data2.current.stored then
							...
							if foundSpawn then
								...
								ESX.Game.SpawnVehicle(data2.current.model, spawnPoint.coords, spawnPoint.heading, function(vehicle)
									...
									TriggerServerEvent('losblancos_vehicleshop:setJobVehicleState', data2.current.vehicleProps.plate, false)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm', {
			...
			if data2.current.value == 'yes' then
				local newPlate = exports['losblancos_vehicleshop']:GeneratePlate()
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		elements = {
			...
			{label = '<span style="color:#669999;">🗡️ Menu Menottes<span style="color:cyan;"> >', value = 'menu_menottes'},
			...
			--{label = '<span style="color:orange;">Menu bracelet éléctronique <span style="color:cyan;"> >', value = 'bracelet'}
	}}, function(data, menu)
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'handcuff' then
						--TriggerServerEvent('esx_policcejob:handcuff85Pasta', GetPlayerServerId(closestPlayer))
		...
		elseif data.current.value == 'bracelet' then
			ESX.UI.Menu.CloseAll()
			TriggerEvent("Ruby_Elec:OpenMenu")
		...
		elseif data.current.value == 'status' then
			...
			local elements = {
				{label = '<span style="color:green;">👮‍♂️ Prise<span style="color:white;"> de service', value = 'prise'},
				{label = '<span style="color:red;">👮‍♂️ Fin<span style="color:white;"> de service', value = 'fin'},
				{label = '<span style="color:orange;">👮‍♂️ Pause<span style="color:white;"> de service', value = 'pause'},
				{label = '<span style="color:orange;">👮‍♂️ Standby<span style="color:gray;">, en attente de dispatch', value = 'standby'},
				{label = '<span style="color:orange;">👮‍♂️Control<span style="color:gray;"> routier en cours', value = 'control'},
				{label = '<span style="color:orange;">👮‍♂️ Refus<span style="color:gray;"> d\'obtempérer / Délit de fuite', value = 'refus'},
				{label = '<span style="color:orange;">👮‍♂️ Crime<span style="color:gray;"> en cours / poursuite en cours', value = 'crime'}
			}
		...
		elseif data.current.value == 'lspd_equipement' then
			...
			elseif grade == 'intendent' then
				table.insert(elements, {label = ('Equipement sergeant-chef'), value = 'equipement_intendent'})
			elseif grade == 'lieutenant' then
				table.insert(elements, {label = ('Equipement Lieutenant'), value = 'equipement_lieutenant'})
			elseif grade == 'chef' then
				table.insert(elements, {label = ('Equipement Capitaine'), value = 'equipement_capitaine'})
			elseif grade == 'boss' then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'lspd_equipement', {
				...
				if action == 'equipement_cadet' then
					...
					ESX.ShowAdvancedNotification('LSPD INFO', 'Armurerie LSPD', 'Voila ton équipement, le perd pas.', 'CHAR_AMMUNATION', 1)
				...
				elseif action == 'equipement_sergeant' then
					...
					ESX.ShowAdvancedNotification('LSPD INFO', 'Armurerie LSPD', 'Voila ton équipement, le perd pas.', 'CHAR_AMMUNATION', 1)
					PlaySoundFrontend(-1, "Bus_Schedule_Pickup", "DLC_PRISON_BREAK_HEIST_SOUNDS", 0)
				elseif action == 'equipement_intendent' then
					PlaySoundFrontend(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 0)
					Citizen.Wait(2000)
					GiveWeaponToPed(PlayerPedId(), "WEAPON_COMBATPISTOL", 255, false, false)
					GiveWeaponToPed(PlayerPedId(), "WEAPON_STUNGUN", 255, false, false)
				...
				elseif action == 'equipement_lieutenant' then
					...
					ESX.ShowAdvancedNotification('LSPD INFO', 'Armurerie LSPD', 'Voila ton équipement, le perd pas.', 'CHAR_AMMUNATION', 1)
					PlaySoundFrontend(-1, "Bus_Schedule_Pickup", "DLC_PRISON_BREAK_HEIST_SOUNDS", 0)
				elseif action == 'equipement_capitaine' then
					PlaySoundFrontend(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 0)
					Citizen.Wait(2000)
					GiveWeaponToPed(PlayerPedId(), "WEAPON_COMBATPISTOL", 255, false, false)
					GiveWeaponToPed(PlayerPedId(), "WEAPON_STUNGUN", 255, false, false)
...
AddEventHandler('esx_policcejob:handcuff85Pasta', function()
