...
function moneyEvent(data, zone)
    ...
    Citizen.CreateThread(function()
        ...
        ShowAdvancedNotification("RESELLER", "~r~EVENT ILLEGAL", data.message, "CHAR_LESTER_DEATHWISH",9)
        ...
        if not EventStop then
            ...
            while ArgentRecup < 10 do
                ...
                if not EventStop then
                    ...
                    local nombre = math.random(120, 250)
                    Popup("~g~+"..nombre.."$")
            ...
            StopSound(sound)
            ShowAdvancedNotification("RESELLER", "~r~EVENT ILLEGAL", "Cargaison récupérée!", "CHAR_LESTER_DEATHWISH",9)
