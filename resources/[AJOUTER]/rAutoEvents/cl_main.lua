...
AddEventHandler("RS_AutoEvents_StopEvent", function(data, zone)
    ...
    ShowAdvancedNotification("RESELLER", "~r~EVENT ILLEGAL", "TERMINER ! Tu n'es pas encore arrivé ? Tu sers vraiment à rien, la prochaine fois accélère !", "CHAR_LESTER_DEATHWISH",9)
    EventStop = true
    removeBlips()
end)
