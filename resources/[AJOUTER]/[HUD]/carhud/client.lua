...
local cruiseInput = 47                     -- Toggle cruise on/off with CAPSLOCK or A button (controller)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if IsPedInAnyVehicle(player, false) then
		 ...
		 if pedInVeh and IsVehicleEngineOn(vehicle) and vehicleClass ~= 13 then
			 ...
			 SetPedConfigFlag(PlayerPedId(), 32, true)
				...
				drawTxt("LIMITEUR", 2, cruiseColor, 0.3, screenPosX + 0.058, screenPosY + 0.013)	
		end
	end
end)
