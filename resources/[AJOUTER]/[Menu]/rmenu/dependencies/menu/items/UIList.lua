...
local SettingsButton = {
	...
	SelectedSprite = { Dictionary = "commonmenu1", Texture = "gradient_nav", Y = 0, Width = 431, Height = 38 }
}

---@type table
local SettingsList = {
	LeftArrow = { Dictionary = "commonmenu1", Texture = "arrowleft", X = 378, Y = 3, Width = 30, Height = 30 },
	RightArrow = { Dictionary = "commonmenu1", Texture = "arrowright", X = 400, Y = 3, Width = 30, Height = 30 },
