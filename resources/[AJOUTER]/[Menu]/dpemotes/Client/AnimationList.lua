...
DP.Walks = {
  ...
  ["Default Femme"] = {"move_f@multiplayer"},
  ["Default Homme"] = {"move_m@multiplayer"},
  ["Determiné"] = {"move_m@brave"},
  ["Bourré"] = {"move_m@drunk@a"},
  ["Bourré 2"] = {"move_m@drunk@slightlydrunk"},
  ["Bourré 3"] = {"move_m@buzzed"},
  ["Bourré 4"] = {"move_m@drunk@verydrunk"},
  ["Femme"] = {"move_f@femme@"},
  ["On Fire"] = {"move_characters@franklin@fire"},
  ["On Fire 2"] = {"move_characters@michael@fire"},
  ["On Fire 3"] = {"move_m@fire"},
  ["Flee"] = {"move_f@flee@a"},
...
DP.Shared = {
   ...
   ["baseballthrow"] = {"anim@arena@celeb@flat@paired@no_props@", "baseball_a_player_b", "Baseball Jeter", "baseball"},
   ...
   ["punched"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_cross_r", "Se faire taper", "punch"},
   ["headbutt"] = {"melee@unarmed@streamed_variations", "plyr_takedown_front_headbutt", "Coup de tête", "headbutted"},
   ["headbutted"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_headbutt", "Prendre coup de tête", "headbutt"},
   ["slap2"] = {"melee@unarmed@streamed_variations", "plyr_takedown_front_backslap", "Giffler", "slapped2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
       EmoteDuration = 2000,
   }},
   ["slap"] = {"melee@unarmed@streamed_variations", "plyr_takedown_front_slap", "Giffler", "slapped", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
       EmoteDuration = 2000,
   }},
   ["slapped"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_slap", "Se faire Giffler", "slap"},
   ["slapped2"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_backslap", "Se faire Giffler 2", "slap2"},
}
...
DP.Dances = {
   ...
   ["danceglowstick"] = {"anim@amb@nightclub@lazlow@hi_railing@", "ambclub_13_mi_hi_sexualgriding_laz", "Dance Bâtons", AnimationOptions =
   {
   ...
   ["danceglowstick2"] = {"anim@amb@nightclub@lazlow@hi_railing@", "ambclub_12_mi_hi_bootyshake_laz", "Dance Bâtons 2", AnimationOptions =
   {
       Prop = 'ba_prop_battle_glowstick_01',
       PropBone = 28422,
       PropPlacement = {0.0700,0.1400,0.0,-80.0,20.0},
   ...
   ["danceglowstick3"] = {"anim@amb@nightclub@lazlow@hi_railing@", "ambclub_09_mi_hi_bellydancer_laz", "Dance Bâtons 3", AnimationOptions =
   {
       Prop = 'ba_prop_battle_glowstick_01',
       PropBone = 28422,
       PropPlacement = {0.0700,0.1400,0.0,-80.0,20.0},
...
DP.Emotes = {
   ...
   ["comeatmebro"] = {"mini@triathlon", "want_some_of_this", "Viens par là, mon pote", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 2000
   }},
   ["cop2"] = {"anim@amb@nightclub@peds@", "rcmme_amanda1_stand_loop_cop", "Flic 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["cop3"] = {"amb@code_human_police_investigate@idle_a", "idle_b", "Flic 3", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["wait4"] = {"amb@world_human_hang_out_street@Female_arm_side@idle_a", "idle_a", "Attend 4", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["wait5"] = {"missclothing", "idle_storeclerk", "Attend 5", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wait6"] = {"timetable@amanda@ig_2", "ig_2_base_amanda", "Attend 6", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wait7"] = {"rcmnigel1cnmt_1c", "base", "Attend 7", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wait8"] = {"rcmjosh1", "idle", "Attend 8", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wait9"] = {"rcmjosh2", "josh_2_intp1_base", "Attend 9", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wait10"] = {"timetable@amanda@ig_3", "ig_3_base_tracy", "Attend 10", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["wait11"] = {"misshair_shop@hair_dressers", "keeper_base", "Attend 11", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
...
-----------------------------------------------------------------------------------------------------------
   ...
   ["clipboard2"] = {"MaleScenario", "WORLD_HUMAN_CLIPBOARD", "Bloc note 2"},
...
DP.PropEmotes = {
   ["umbrella"] = {"amb@world_human_drinking@coffee@male@base", "base", "pare-pluie", AnimationOptions =
   {
...
-----------------------------------------------------------------------------------------------------
   ...
   ["notepad"] = {"missheistdockssetup1clipboard@base", "base", "Bloc Note 3", AnimationOptions =
   {
   ...
   ["suitcase"] = {"missheistdocksprep1hold_cellphone", "static", "Valise Tissu", AnimationOptions =
   {
   ...
   ["suitcase2"] = {"missheistdocksprep1hold_cellphone", "static", "Valise Metal", AnimationOptions =
   {
   ...
   ["clipboard"] = {"missfam4", "base", "Bloc note", AnimationOptions =
   {
   ...
   ["makeitrain"] = {"anim@mp_player_intupperraining_cash", "idle_a", "Jeter de l'argent", AnimationOptions =
   {
   ...
   ["champagnespray"] = {"anim@mp_player_intupperspray_champagne", "idle_a", "Secoué Champagne", AnimationOptions =
   {
