...
rootMenuConfig =  {
    {
        ...
        icon = "#globe-europe",
        enableMenu = function()
        fuck = exports["losblancos_ambulance"]:GetDeath()
            return not fuck
        end,
    ...
    },
    {
        ...
        subMenus = {"cuffs:cuff", "cuffs:uncuff", "police:escort", "police:putinvehicle", "police:unseatnearest", "cuffs:checkinventory", --[[ "cuffs:remmask",  "police:frisk", ]]--[[ "police:removeweapons" ]] "police:revive", "police:gsr", "police:openmdt", "police:getid", "police:impound"}
    },
    {
        id = "police-vehicle",
...
--[[     ['cuffs:remmask'] = {
    ...
    ['cuffs:unseat'] = {
        ...
        functionName = "losblancos_ambulance:pullOutVehicle"
    },
    ['cuffs:checkphone'] = {
        title = "Read Phone",
