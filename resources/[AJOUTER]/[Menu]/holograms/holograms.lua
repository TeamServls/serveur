...
function Holograms()
		...
		if GetDistanceBetweenCoords( -206.13,-1012.370, 30.138, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			Draw3DText( -854.89,-127.56, 37.72, "Bienvenue sur ~b~PRLServ", 4, 0.1, 0.1)
			Draw3DText( -854.89,-127.56, 37.52, "Pour avoir de l'aide rejoignez le discord : ", 4, 0.1, 0.1)
			Draw3DText( -854.89,-127.56, 37.32, "~b~https://discord.gg/g2vz3S2", 4, 0.1, 0.1)		
		end		
	end
end
