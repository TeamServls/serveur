...
window.addEventListener("message", function (event) {
    ...
    if (event.data.action == "display") {
        ...
        $.each(event.data.players, function (index, player) {
            $("#modal_give > .modal-content").append('<button class="waves-effect waves-red btn-flat btn-near-player white-text" data-player="' + player.player + '">#' + player.player + '</button>');
        });
...
function inventoryPoliceSetup(items) {
    ...
    $.each(items, function (index, item) {
        ...
        var itemtype = "normal";
        var itemimage = "items"
        if(item.name == "water" || item.name == "cola" || item.name == "fanta" || item.name == "sprite" || item.name == "loka" || item.name == "soda" || item.name == "cocacola" || item.name == "icetea" || item.name == "jusfruit" || item.name == "redbull" || item.name == "caprisun" || item.name == "drpepper" || item.name == "limonade" || item.name == "tequila" || item.name == "jagerbomb" || item.name == "martini" || item.name == "rhum" || item.name == "whisky" || item.name == "vodka"){
            using_icon = 'local_drink';
        }else if(item.name == "bread" || item.name == "burger" || item.name == "milho" || item.name == "feijao" || item.name == "Chips" || item.name == "chips" || item.name == "sandwich" || item.name == "cheesebows" || item.name == "pizza"  || item.name == "chocolat" || item.name == "pastacarbonara" || item.name == "cupcake" || item.name == "raisin" || item.name == "bolchips" || item.name == "mixapero" || item.name == "grapperaisin" || item.name == "saucisson" || item.name == "bolcacahuetes" || item.name == "bolnoixcajou" || item.name == "bolpistache"){
        ...
        if(item.name == "water" || item.name == "cola" || item.name == "fanta" || item.name == "sprite" || item.name == "loka" || item.name == "soda" || item.name == "cocacola" || item.name == "icetea" || item.name == "jusfruit" || item.name == "redbull" || item.name == "caprisun" || item.name == "drpepper" || item.name == "limonade" || item.name == "tequila" || item.name == "jagerbomb" || item.name == "martini" || item.name == "rhum" || item.name == "whisky" || item.name == "vodka" || item.name == "bread" || item.name == "burger" || item.name == "milho" || item.name == "feijao" || item.name == "Chips" || item.name == "sandwich" || item.name == "chips" || item.name == "cheesebows" || item.name == "pizza"  || item.name == "chocolat" || item.name == "pastacarbonara" || item.name == "cupcake" || item.name == "raisin" || item.name == "bolchips" || item.name == "mixapero" || item.name == "grapperaisin" || item.name == "saucisson" || item.name == "bolcacahuetes" || item.name == "bolnoixcajou" || item.name == "bolpistache"){
            itemtype = "item_food";
...
function inventorySetup(items) {
    ...
    $.each(items, function (index, item) {
        ...
        if(item.name == "water" || item.name == "cola" || item.name == "fanta" || item.name == "sprite" || item.name == "loka" || item.name == "soda" || item.name == "cocacola" || item.name == "icetea" || item.name == "jusfruit" || item.name == "redbull" || item.name == "caprisun" || item.name == "drpepper" || item.name == "limonade" || item.name == "tequila" || item.name == "jagerbomb" || item.name == "martini" || item.name == "rhum" || item.name == "whisky" || item.name == "vodka" || item.name == "bread" || item.name == "burger" || item.name == "milho" || item.name == "feijao" || item.name == "Chips" || item.name == "chips" || item.name == "sandwich" || item.name == "cheesebows" || item.name == "pizza"  || item.name == "chocolat" || item.name == "pastacarbonara" || item.name == "cupcake" || item.name == "raisin" || item.name == "bolchips" || item.name == "mixapero" || item.name == "grapperaisin" || item.name == "saucisson" || item.name == "bolcacahuetes" || item.name == "bolnoixcajou" || item.name == "bolpistache"){
            itemtype = "item_food";
        }else if(item.name == "key" || item.name == "keyhouse"){
            itemtype = "item_key";
        }
    ...
    $('body').on('click','#item-submit[data-action="give"]', function(){
        ...
        if(itemData.type == "item_key" || itemData.type == "item_keyhouse"){
            ...
            if(count > 0){
                ...
                $("#text_result").text("Montant invalide").show();
                return false;
            }
        }
