	...
	ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(vehicles)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
			...
			ESX.Game.SpawnVehicle(vehicleProps.model, vehSpawnPoint, vehSpawnHeading, function(vehicle)
				...
				TriggerEvent("RS_KEY:GiveKey", GetVehicleNumberPlateText(vehicle))
...
function OpenVehicleInfosMenu(vehicleData)
	ESX.TriggerServerCallback('GangsBuilderJob:getVehicleInfos', function(infos)
		local elements = {}
...
function OpenBuyWeaponsMenu()
	ESX.TriggerServerCallback('GangsBuilderJob:getArmoryWeapons', function(weapons)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_buy_weapons', {
			...
			ESX.TriggerServerCallback('GangsBuilderJob:buy', function(hasEnoughMoney)
		...
		if CurrentAction ~= nil then
			...
			if IsControlPressed(0, 38) and PlayerData.job2 ~= nil and ActualGang and (GetGameTimer() - GUI.Time) > 150 then
				...
				if CurrentAction == 'menu_boss_actions' then
					...
					TriggerEvent('esx_society:OpenOrgaMenu', ActualGang.Name, function(data, menu)
						CurrentAction = 'menu_boss_actions'
						CurrentActionMsg = _U('open_bossmenu')
						CurrentActionData = {}
					end, {wash = false})
